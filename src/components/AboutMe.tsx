  ...
  return (
    <section className="relative text-white p-8 rounded-2xl shadow-2xl max-w-5xl mx-auto mt-16 overflow-hidden border border-white/10">
      ...
      <div className="relative z-10 backdrop-blur-md">
        ...
        >
          Hello there! I’m <span className="text-blue-400 font-semibold">Ayush Choudhary</span> — a passionate
          <span className="text-yellow-300 font-medium"> Software Developer</span> pursuing
