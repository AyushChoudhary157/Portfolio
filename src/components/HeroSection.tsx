...
const HeroSection = ({
  ...
  introduction = "Transforming ideas into digital experiences. I specialize in crafting responsive web applications that are fast, functional, and visually engaging—bridging the gap between creativity and code.",
  onExploreClick = () => {
