...
const Navigation = ({ className = "" }: NavigationProps) => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: "https://mail.google.com/mail/u/0/#inbox?compose=CllgCJlLWxxlgnrfRldmPZdDqjPrQTVSLqBKxfJhwQXFwfhnXpBFLlvpdPQcvpQNbGqDRzjSZDV",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="p-6 border-b border-white/10">
        <h2 className="text-2xl font-bold leading-tight">Ayush Choudhary</h2>
        <p className="text-sm text-slate-400 mt-1">Software Developer</p>
      </div>
